...
@section('content')
    <div class="relative flex flex-col text-gray-700 bg-transparent shadow-none rounded-xl bg-clip-border">
        ...
        <form class="max-w-screen-lg mt-8 mb-2 w-80 sm:w-96" method="POST"
            ...
            <div class="flex flex-col gap-6 mb-1">
                ...
                <div class="relative h-11 w-full min-w-[200px]">
                    <input value="{{ $article->title }}" name="title" placeholder="example title"
                ...
                <div class="relative h-11 w-full min-w-[200px]">
                    <textarea name="content" id="message" rows="4"
                              ...
                              placeholder="Write your thoughts here...">{{ $article->content }}</textarea>
